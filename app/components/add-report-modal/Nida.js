...
function Nida() {
 ...
 <input onChange={e=>dispatch(addReport({action:'nida',data:e.target.value}))} type="number" className="bg-gray-50 border focus:ring-gray-800 focus:border-gray-800 border-gray-300 text-gray-900 text-sm rounded-lg  w-20 p-2.5  text-center" placeholder="الدورية" />
