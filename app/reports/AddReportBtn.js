...
<div className=' flex justify-center items-center'>    انشاء حدث
  ...
  </Button>      <Modal position='top-center' size='7xl' show={openModal} onClose={() => setOpenModal(false)}>
        <Modal.Body>
        <div >
      <h1 className=" text-center mb-1 font-semibold text-gray-900 ">حدد موقع الحدث</h1>
      <MapComponent />
    </div>
