...
function Reports() {
  ...
  if(data) return (
    <div className='w-[40vh]  ring-2 ring-neutral-600 rounded-lg resize-x overflow-auto'>
        <div className=' text-center font-semibold py-2 text-black'>الأحداث الأخيرة</div>
...
{data.map(report=>{
    ...
    <div className=' px-2  whitespace-nowrap flex     cursor-pointer text-black  bg-gray-200 font-semibold py-3 gap-x-2'>
    <div >{report.type}</div>
